      ...
      {isLoading ? (
        ...
        <div className="flex h-screen items-center justify-center">
          <form className="w-96 p-8 shadow-2xl" onSubmit={handleSubmit}>
            ...
            <h1 className="text-4xl font-bold dark:text-gray-800 text-orange-600">
              Login
            </h1>
            <div className="grid pt-2">
              <label htmlFor="username" className="mb-2">
                <span className="dark:text-slate-800 text-stone-700">
                  Email:
                </span>
              </label>
              <input
            ...
            <div className="grid mt-6">
              <button className="border bg-white text-stone-700 hover:bg-amber-500 hover:border-amber-500 rounded-lg p-2 disabled:cursor-not-allowed">
                Sign In
              </button>
            </div>
